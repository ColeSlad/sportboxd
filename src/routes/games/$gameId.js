...
function BoxScoreTable({ homeTeam, awayTeam }) {
    return (_jsxs("table", { className: "w-full border-collapse text-[0.82rem]", children: [_jsx("thead", { children: _jsx("tr", { className: "border-b border-border", children: ['Player', 'MIN', 'PTS', 'REB', 'AST', 'FG%', '3P%', 'STL', 'BLK'].map((col) => (_jsx("th", { className: "pb-2 pt-1 text-[0.68rem] font-condensed font-bold tracking-widest uppercase text-gray-600 whitespace-nowrap", style: { textAlign: col === 'Player' ? 'left' : 'right', padding: '6px 10px' }, children: col }, col))) }) }), _jsx("tbody", { children: MOCK_STATS.map((row) => (_jsxs("tr", { className: "border-b border-border/50 hover:bg-bg-card2 transition-colors", children: [_jsx("td", { className: "py-2.5 px-2.5", children: _jsxs("div", { className: "flex items-center gap-2", children: [_jsx(TeamLogo, { abbr: row.team, size: 18 }), _jsx("span", { className: "font-medium", children: row.player })] }) }), _jsx("td", { className: "py-2.5 px-2.5 text-right text-gray-600", children: row.min }), _jsx("td", { className: "py-2.5 px-2.5 text-right font-bold", children: row.pts }), _jsx("td", { className: "py-2.5 px-2.5 text-right", children: row.reb }), _jsx("td", { className: "py-2.5 px-2.5 text-right", children: row.ast }), _jsx("td", { className: "py-2.5 px-2.5 text-right", children: row.fgPct }), _jsx("td", { className: "py-2.5 px-2.5 text-right", children: row.fg3Pct }), _jsx("td", { className: "py-2.5 px-2.5 text-right", children: row.stl }), _jsx("td", { className: "py-2.5 px-2.5 text-right", children: row.blk })] }, row.player))) })] }));
}
